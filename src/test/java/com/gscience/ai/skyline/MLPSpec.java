package com.gscience.ai.skyline;

import com.gscience.ai.utility.PlotUtil;
...
public class MLPSpec {

    @Test
    void mLPClassifierLinear () throws IOException, InterruptedException {
